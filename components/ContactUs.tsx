    ...
    return (
        <>
            <Head>
                ...
                {/* SEO Meta Tags */}
                <title>Contact Us | Om Sritara – Spiritual Products Store India</title>
                <meta
                    name="description"
                    content="Get in touch with Om Sritara for spiritual jewellery, malas and divine statues. Contact our support team for orders and enquiries."
                />
                        ...
                        <div className="space-y-10">
                            ...
                            <div>
                                ...
                                <div className="flex items-start gap-3 text-sm text-gray-700">
                                    ...
                                    <div>
                                        <a href="tel:+91 7092973555" className="text-gray-400 hover:text-purple-700 transition-colors">+91 89890-52020</a>
