...
export default function StonePage({ stone, monthKey }: StonePageProps) {
    const [currentFormat, setCurrentFormat] = useState("Loose Gemstone");
    ...
    return (
        <div className="bg-gray-50 min-h-screen pb-16 pt-8">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 flex flex-col md:flex-row">

                    {/* Left: Image Section */}
                    <div className="w-full md:w-1/2 bg-gray-100/50 relative rounded-t-3xl md:rounded-tr-none md:rounded-bl-3xl">
                        <div className="p-10 pt-20 flex flex-col items-center justify-start min-h-[400px] md:sticky md:top-0">
                            ...
                            {activeMedia === "video" ? (
                                <div className="w-full max-w-[400px] aspect-square flex items-center justify-center bg-gray-200/50 rounded-2xl overflow-hidden shadow-2xl relative">
                                    <video
                    ...
                    <div className="w-full md:w-1/2 p-10 md:p-14 flex flex-col justify-center">
                        <div className="mb-6 border-b border-gray-100 pb-6">
                            <h1 className="text-4xl font-extrabold text-[#0a192f] mb-2 font-serif">{stone.name}</h1>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`text-sm px-4 py-2 rounded-lg font-bold transition-colors border-2 ${isSelected
                                                ? 'bg-[#3b82f6] text-white border-black shadow-md'
                            ...
                            <div className="mb-10 border-t border-gray-200 pt-8">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                                    {[
                                        ...
                                        { id: "Panchdhatu", name: "Panchdhatu (Mix of five Metals)", img: "/images/metals/panchdhatu.png" },
                                        { id: "22k Yellow Gold", name: "22k Yellow Gold", img: "/images/metals/gold.png" },
                                        { id: "18k White Gold", name: "18k White Gold", img: "/images/metals/silver.png" },
                                        { id: "18k Yellow Gold", name: "18k Yellow Gold", img: "/images/metals/gold.png" },
                                    ].map((metal) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex flex-col items-center justify-start p-3 rounded-lg border transition-all bg-white ${isSelected ? 'border-orange-500 shadow-sm ring-1 ring-orange-500' : 'border-gray-200 hover:border-gray-300 hover:shadow-sm'
                                                    }`}
                                            >
        ...
        py-4 rounded-xl
        bg-gradient-to-r from-[#8B0000] via-[#B8860B] to-[#8B0000]
        bg-[length:200%_100%]
        ...
        hover:scale-[1.02]
        hover:shadow-xl hover:shadow-[#B8860B]/40
